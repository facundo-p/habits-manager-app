...
- [x] 04-04-PLAN.md — Restore pre-clean en backupService (REQ-04-03 integration) + ARCHITECTURE.md doc-fix (Regla 3.4 CLAUDE.md) + 04-VALIDATION.md per-task map filled (nyquist_compliant: true)
